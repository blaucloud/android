package de.blaucloud.android.test;

import de.blaucloud.android.db.ProviderMeta.ProviderTableMeta;
import de.blaucloud.android.providers.FileContentProvider;
...
public class FileContentProviderTest extends ProviderTestCase2<FileContentProvider> {
	...
	public FileContentProviderTest() {
		super(FileContentProvider.class, "de.blaucloud.android.providers.FileContentProvider");
	}
